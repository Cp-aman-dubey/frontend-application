...
class UpdateAssociateComponent extends Component {
    constructor(props) {
        super(props)
        ...
        this.updateAssociate = this.updateAssociate.bind(this);
    }
                   ...
                   <div className = "container">
                        <div className = "row">
                            <div className = "card col-md-6 offset-md-3 offset-md-3">
                                <h3 className="text-center">Update Associate</h3>
                                <div className = "card-body">
                                    <form>
                                        ...
                                        <button className="btn btn-success" onClick={this.updateAssociate}>Save</button>
...
export default UpdateAssociateComponent